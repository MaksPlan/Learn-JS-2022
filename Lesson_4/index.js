...
//2 Задача
// let arrayNum = [-1, 0, 3, 4, -5];
// let sumOfPositiveNum = 0;
// for (let i = 0; i < arrayNum.length; i++) {
//     if (arrayNum[i] > 0) {
//         sumOfPositiveNum += arrayNum[i];
//     }
// }
// console.log(sumOfPositiveNum);

//3 Задача
// let arrayNum = [1, 2, 5, 9, 4, 13, 4, 10];
// for (let i = 0; i < arrayNum.length; i++) {
//     if (arrayNum[i] === 4) {
//         console.log('Есть!')
//     }
...
let arrayNum = [10, 20, 30, 50, 235, 3000];
for (let i = 0; i < arrayNum.length; i++) {
let firstElement = arrayNum[i];
firstElement.toString;
if (firstElement[0] === '1' || firstElement === '2' || firstElement[0] === '5') {
